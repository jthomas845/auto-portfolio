                ...
                <Link key={index} href={project} className="sb-project-feed-item block group">
                    <article className="border-b border-current h-full pb-10 max-w-3xl">
                        ...
                        {showDate && project.date && (
                                <ProjectDate date={project.date} style="display: inline-block;">
                                {project.endDate && <span> <p style="display: inline-block;"> - <ProjectDate date={project.endDate} style="display: inline-block;"/> </p></span>
                                    }</ProjectDate>
                        )}
                        <h3>{project.title}</h3>
                        ...
                        <div className="md:flex md:items-center">
                            {showFeaturedImage && project.featuredImage && (
                                <div className="mb-8 md:shrink-0 md:self-stretch md:w-48 md:mb-0 md:mr-8">
                                    <div className="block h-0 w-full pt-2/3 relative overflow-hidden md:h-24 md:min-h-full">
                                        <ImageBlock
                                            {...project.featuredImage}
                                            className="absolute left-0 top-0 h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                                        />
